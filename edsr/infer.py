...
## Create model
model = torch.load("edsr_x2_72_2.90992.pth", map_location=torch.device(device))
model.eval()

## Read image
img = cv2.imread("Dataset\DIV2K_train_HR\\0793.png")
img = img.astype(np.float32)
lr = cv2.resize(img, (256,256))
hr = cv2.resize(img, (512,512))
